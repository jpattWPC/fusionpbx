...
//show the content
	...
	echo "	".$text['label-ibr_pilot']."\n";
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "	<input class='formfld' type='text' name='ibr_pilot' maxlength='255' value=\"".escape($ibr_pilot)."\">\n";
	echo "<br />\n";
	echo $text['description-ibr_pilot']."\n";
	echo "</td>\n";
	echo "</tr>\n";

	echo "<tr>\n";
	echo "<td class='vncell' valign='top' align='left' nowrap='nowrap'>\n";
	echo "	".$text['label-ibr_pilot_json']."\n";
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "	<input class='formfld' type='text' name='ibr_pilot_json' maxlength='255' value=\"".escape($ibr_pilot_json)."\">\n";
	echo "<br />\n";
	echo $text['description-ibr_pilot_json']."\n";
	echo "</td>\n";
	echo "</tr>\n";
